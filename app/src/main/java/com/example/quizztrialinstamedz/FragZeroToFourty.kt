...
import com.example.quizztrialinstamedz.databinding.FragmentFragZeroToFourtyBinding


class FragZeroToFourty : Fragment() {
    lateinit var binding: FragmentFragZeroToFourtyBinding
...
private fun checkAns(answer:String){
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_frag_zero_to_fourty,
            container,
            false
        )
        setQuestion()
